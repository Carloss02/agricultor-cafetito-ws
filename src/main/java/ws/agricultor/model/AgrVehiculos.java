...
public class AgrVehiculos  implements java.io.Serializable {
    ...
    public AgrVehiculos(String placaVehiculo, Integer estadoVehiculo, String marcaVehiculo, Integer modeloVehiculo, String colorVehiculo, String tipoVehiculo, BigDecimal pesoVehiculo, String usuarioCreacion, Date fechaCreacion) {
       this.placaVehiculo = placaVehiculo;
