...
@Entity
@Table(name="agr_transportistas"
    ,catalog="db_agricultor"
)
public class AgrTransportistas  implements java.io.Serializable {
    ...
    public AgrTransportistas() {
    }

	
    public AgrTransportistas(String idLicencia, Date fechaCreacion) {
        this.idLicencia = idLicencia;
        this.fechaCreacion = fechaCreacion;
    }
    public AgrTransportistas(String idLicencia, Integer estadoTransportista, String tipoLicencia, String nombreTransportista, String telefonoTransportista, String emailTransportista, String usuarioCreacion, Date fechaCreacion) {
       this.idLicencia = idLicencia;
